...
import { EXPERIENCE_INPUT_LIMITS } from "@/lib/experienceInputLimits";
import {
...
const ANSWER_DRAFT_MODEL = AI_MODELS.answerDrafts;
const OPENAI_REQUEST_TIMEOUT_MS =
  AI_API_REQUEST_LIMITS.answerDrafts.openAiTimeoutMs;
const MAX_ID_LENGTH = 160;
const {
  title: MAX_EXPERIENCE_TITLE_LENGTH,
  period: MAX_EXPERIENCE_PERIOD_LENGTH,
  role: MAX_EXPERIENCE_ROLE_LENGTH,
  description: MAX_EXPERIENCE_DESCRIPTION_LENGTH,
  achievements: MAX_EXPERIENCE_ACHIEVEMENTS_LENGTH,
