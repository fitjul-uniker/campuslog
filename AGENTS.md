...
`PRD.md` > `docs/FLOW.md` / `docs/IA.md` / `docs/SCREEN_SPEC.md` > `README.md` > 현재 코드와 데이터
...
현재는 문서와 초기 구조를 준비하는 단계입니다. 구현 작업 전에는 `PRD.md`, `docs/FLOW.md`, `docs/IA.md`, `docs/SCREEN_SPEC.md`, `README.md`의 MVP 범위, 핵심 기능, 제외 기능이 서로 일치하는지도 확인합니다.
