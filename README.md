...
- 답변 초안 생성: 자기소개서 300자 / 500자 / 1000자 프리셋과 100~2000자 직접 입력 + 면접·JD·기타 목적별 버전
...
현재 또는 미래 활동은 제목, 간단한 내용, 시작일, 예상 종료일 또는 미정만 먼저 등록할 수 있습니다. 사용자는 캘린더에서 오늘과 과거 날짜에 실제로 한 일을 활동과 연결해 쌓고, 오늘 기준 12개월 안의 미래 날짜에는 활동 기간에 맞춘 계획을 미리 적을 수 있습니다. 활동 종료 시 AI는 미래 계획을 제외한 실제 기록만 사실 기반으로 정리하며, 사용자가 초안을 검토한 뒤 완료 경험으로 저장합니다.
