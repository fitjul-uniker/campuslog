...
1. 기록 보완 루프: AI 보완 질문, 사용자 답변, 분석 재생성
2. OCR / JD 이미지 입력: 텍스트 붙여넣기 흐름 안정화 후 Optional로 검토
3. AI API 보호 foundation 실제 세션 환경 smoke test와 durable rate limit / OpenAI spend alert 운영 결정
4. 추천 v2 / 답변 초안 migration 적용 후 로그인 세션 저장 smoke test
