...
1. 답변 초안 생성: 300자 / 700자 / 면접 / 포트폴리오 버전 제공
2. 기록 보완 루프: AI 보완 질문, 사용자 답변, 분석 재생성
...
5. 추천 v2 migration 적용 후 로그인 세션 저장 smoke test
...
- 답변 초안, 기록 보완 루프의 평가 기준과 회귀 사례 필요
