...
1. 추천 v2: 문항 / JD 요구사항 추출, 경험 Top 3 매칭, 부족 근거 표시
2. 답변 초안 생성: 300자 / 700자 / 면접 / 포트폴리오 버전 제공
3. 기록 보완 루프: AI 보완 질문, 사용자 답변, 분석 재생성
...
- 추천 Top 3, 답변 초안, 기록 보완 루프의 평가 기준과 회귀 사례 필요
